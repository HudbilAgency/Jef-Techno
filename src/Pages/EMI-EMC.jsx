...
const VerticalCarousel = () => {
  const benefitItems = [
    ...
    "Why Choose JEF for EMI/EMC Studies?",
  ];
  ...
  const cardContents = [
    {
      ...
      description:
        "Electromagnetic interference (EMI) can disrupt the performance of electrical systems, leading to operational inefficiencies, equipment malfunctions, and potential safety hazards. EMC ensures that all electrical components within a system operate without generating or being affected by electromagnetic disturbances. Effective EMI/EMC management is crucial for:|Ensuring Operational Continuity: Avoiding disruptions caused by electromagnetic interference.|Protecting Sensitive Equipment: Preventing damage to devices due to unregulated electromagnetic emissions.|Compliance with Standards: Adhering to international regulations such as IEC 61000 and IEEE 299.",
    },
    {
      imgSrc:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfe22fc28df7bfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
    ...
    },
    {
      ...
      description:
        "Our EMI/EMC studies are tailored to meet the needs of various industries:|Oil & Gas: Protecting sensitive monitoring equipment in high-interference environments.|Power Utilities: Ensuring compatibility in substations, grid stations, and renewable energy plants.| Manufacturing: Minimizing interference in automated production lines.|Healthcare: Securing medical devices in hospitals and ensuring compatibility with essential systems.|Data Centers: Protecting IT infrastructure from EMI-related risks to ensure continuous operations.",
    },
    {
      imgSrc:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/6ea8583cc00a44231bfb61be46e3517321fdd08d7a42dfe22fc28df7bfdc2e24?placeholderIfAbsent=true&apiKey=7904fd7afaaf4ee2b0837ab86d91b244",
    ...
    <section>
      <div className="overflow-hidden py-20 w-full bg-stone-900 max-md:pt-24 px-5 md:px-12 lg:px-0 max-md:mt-10 max-md:w-full">
        <div className="flex flex-col lg:flex-row w-full xl:w-[95%] gap-5 max-md:flex-col">
          ...
          <div className="relative flex flex-col w-[56%] max-sm:h-[80vh] max-lg:h-[53vh] overflow-hidden max-md:ml-0 max-lg:w-full">
            <div
