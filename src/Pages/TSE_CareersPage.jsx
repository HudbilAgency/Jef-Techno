...
const iconTextItems = [
  ...
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/dc582fb81a3a7a17863b2c30e7f80a664d8c08f51514a8b03cd1568c2212adf8?placeholderIfAbsent=true&apiKey=ec02862acd164f0aad3ceef0d2a999c3", text: "$40000-$42000" },
  { icon: "https://cdn.builder.io/api/v1/image/assets/TEMP/aad532364fe57b522dac121a9ba4aad021d2c2f53556e2277d6daa3ba45b1580?placeholderIfAbsent=true&apiKey=ec02862acd164f0aad3ceef0d2a999c3", text: "New-York, USA" }
];
      ...
      <section className="flex p-4 flex-col items-start self-center mt-24 w-full max-w-[81rem] max-md:mt-10 max-md:max-w-full">
        <article className="flex flex-col self-stretch pt-8 w-full rounded-3xl  max-md:max-w-full">
          <div className="flex flex-wrap gap-10 justify-between items-start w-full text-base text-red-700 max-md:max-w-full">
            <span className="flex flex-col justify-center p-2 rounded-xl bg-red-700 bg-opacity-10">
              10 min ago
            </span>
          ...
          <div className="flex flex-wrap gap-5 items-start self-start mt-6 text-stone-900 max-md:max-w-full">
            ...
            <div className="flex flex-col min-w-[15rem] max-md:max-w-full">
              ...
              <p className="mt-5 text-base">JEF Group</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-10 justify-between items-end mt-7 w-full text-base font-semibold max-md:max-w-full">
            ...
            <button className="overflow-hidden gap-2.5 self-stretch p-5 text-white bg-red-700 rounded-lg min-h-[3.125rem] min-w-[15rem] w-[18.813rem]">
              Apply Job
            </button>
          </div>
        </article>
        ...
        {overviewItems.map((item, index) => (
          <div key={index} className="flex gap-5 items-start mt-7 w-full first:mt-0">
            ...
            <div className="flex flex-col flex-1 shrink basis-0">
              ...
              <div className="mt-3 text-gray-500">{item.value}</div>
            </div>
          </div>
        ))}
      </div>
    ...
    <section className="flex flex-col w-[76%] max-md:ml-0 max-md:w-full">
      <div className="flex flex-col grow items-start mt-6 text-base text-stone-900 max-md:mt-10 max-md:max-w-full">
        ...
        <article className="flex flex-col self-stretch max-md:max-w-full">
          <h2 className="text-2xl font-semibold">About JEF:</h2>
...
const SectionTitle = ({ children }) => (
    <h2 className="text-2xl font-semibold mt-14 max-md:mt-10">
      {children}
    </h2>
  );
