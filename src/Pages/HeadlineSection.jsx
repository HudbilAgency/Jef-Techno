...
const HeadlineSection = () => (
  <>
  <section className="flex relative flex-col self-center mt-16 w-full  max-md:mt-10 max-md:max-w-full">
    <div className="flex justify-between mx-[100px]">
        <button className="flex flex-col justify-end px-1 py-2 w-14 rounded-full border border-white border-solid">
  ...
  <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/294404525c18fdbaa9f653036e40ee212908398c77171f1630872999832f8f9e?placeholderIfAbsent=true&apiKey=60c6eb6ce37644fdb727618799199006" alt="Footer icon" className="object-contain self-end mr-28 aspect-square w-[60px] max-md:mr-2.5" />
  </>
