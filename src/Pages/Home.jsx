    ...
    <div className="relative w-full h-screen overflow-hidden">
      <div ref={carouselRef} className="bg-no-repeat flex w-[300%] h-full ">
        <div className="relative w-full h-full ">
          ...
          <div className="2xl:mt-[35rem] p-4 inset-y-3/4 md:inset-0 md:p-0 lg:mx-[200px] flex relative flex-col self-center w-full max-w-[1310px] max-md:mt-10 max-md:max-w-full ">
        ...
        <div className="2xl:mt-[35rem] p-4 inset-y-48 md:inset-0 md:p-0 lg:mx-[200px] flex relative flex-col self-center w-full max-w-[1310px] max-md:mt-10 max-md:max-w-full ">
            <h1 className="lg:text-6xl  2xl:text-7xl font-bold h-40 2xl:h-36 my-auto tracking-wider text-white max-md:max-w-full max-md:text-4xl">
        ...
        <div className="2xl:mt-[35rem] px-1 inset-y-72 md:inset-0 md:p-0 lg:mx-[200px] flex relative flex-col self-center w-full max-w-[1310px] max-md:mt-10 max-md:max-w-full ">
            <h1 className="lg:text-6xl  2xl:text-7xl font-bold h-20 2xl:h-36 my-auto tracking-wider text-white max-md:max-w-full max-md:text-4xl">
