...
< Navbar />
    <div className="relative w-full h-screen overflow-hidden">
      <div ref={carouselRef} className="bg-no-repeat flex w-[300%] h-full ">
        ...
        <div className="2xl:mt-[35rem] p-4 inset-y-52 md:inset-0 md:p-0 lg:mx-[200px] flex relative flex-col self-center w-full max-w-[1310px] max-md:mt-10 max-md:max-w-full ">
