   ...
   <>
    ...
    <section className="px-[5%] py-[4%] bg-gray-100">
        ...
        <header className="flex flex-col w-full text-2xl font-semibold uppercase text-stone-900 tracking-[2.06px] max-md:max-w-full">
            ...
            DIGITIZATION SOLUTIONS FOR <br />STRUCTURED
ELECTRICAL, FIRE SAFETY <br />& HVAC AUDIT ACCORDING TO LOCAL <br />
REGULATIONS SCALE WITH 100% <br />ACCURACY, CONSISTANCY & SPEED.
            </h1>
        </header>
        </main>
    </section>
